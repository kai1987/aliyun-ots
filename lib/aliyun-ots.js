var Client, Schema, _, bindCallback, exports, fs, nodefn, path, request, requestFn, schema, schemaDesc, schemas, utility, whenjs;
...
Client.prototype.query = function(action, params, cb) {
  var body, ref, requestResult;
  if (_.isFunction(params)) {
    ref = [null, params], params = ref[0], cb = ref[1];
  }
  if (params) {
...
Client.prototype.request = function(opAction, body) {
  ...
  return request({
    ...
    return function(arg) {
      var body, error, error1, info, protoResponse, res, result, statusCode;
